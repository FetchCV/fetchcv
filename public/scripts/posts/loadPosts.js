...
`;
    ...
    setTimeout(() => {
        ...
        const carousel = postElement.querySelector('.carousel-images');
        const prevButton = postElement.querySelector('.carousel-prev');
        const nextButton = postElement.querySelector('.carousel-next');
        let current = 0;
